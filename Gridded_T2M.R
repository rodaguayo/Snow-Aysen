...
sample <- rast(matrix(rnorm(40*40),40,40), crs = "+init=epsg:4326")
...
time(t2m_max_era5) <- seq(from = as.POSIXct("2016-01-01", tz="UTC"), to = as.POSIXct("2021-12-10", tz="UTC"), by = "day")
...
time(t2m_min_era5) <- seq(from = as.POSIXct("2016-01-01", tz="UTC"), to = as.POSIXct("2021-12-10", tz="UTC"), by = "day")
...
t2m_min_era5<-t2m_min_era5+(dem_lr-dem_hr)*0.0065
...
t2m_max_data <-read.csv("C:/Users/rooda/Dropbox/Proyectos/Semilla-Aysen/Data/T2Mmax_data_d.csv")
t2m_min_data <-read.csv("C:/Users/rooda/Dropbox/Proyectos/Semilla-Aysen/Data/T2Mmin_data_d.csv")
t2m_shape<-read.csv("C:/Users/rooda/Dropbox/Proyectos/Semilla-Aysen/Data/PP_metadata.csv")
pp_shape<-as(pp_shape)

pp_data$date<-as.POSIXct(pp_data$date, format = "%Y-%m-%d")
...
writeCDF(t2m_max_era5, "C:/Users/rooda/Dropbox/Proyectos/Semilla-Aysen/Results/T2M_max_Corrected.nc", overwrite=TRUE, varname="t2m_max", unit="degC", 
         longname="Maximum temperature", zname="time", compression = 9)

writeCDF(t2m_min_era5, "C:/Users/rooda/Dropbox/Proyectos/Semilla-Aysen/Results/T2M_min_Corrected.nc", overwrite=TRUE, varname="t2m_min", unit="degC", 
