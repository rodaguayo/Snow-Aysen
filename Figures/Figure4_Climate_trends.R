...
y1 <- list(titlefont = f, title = "tx90p", tickfont = f2, ticks = "outside", zeroline = FALSE)
...
y2 <- list(titlefont = f, title = "rx5day", tickfont = f2, ticks = "outside", zeroline = FALSE, side = "right", dtick = 100)
...
y3 <- list(titlefont = f, title = "ssdi", tickfont = f2, ticks = "outside", zeroline = FALSE, dtick = 3)
...
y4 <- list(titlefont = f, title = "prcptot", tickfont = f2, ticks = "outside", zeroline = FALSE, side = "right")
...
y5 <- list(titlefont = f, title = "dtr", tickfont = f2, ticks = "outside", zeroline = FALSE)
...
server <- orca_serve()
server$export(fig, file = "C:/Users/rooda/Dropbox/Proyectos/Semilla-Aysen/Figures/Figure_trends.png", width = 900, height = 1200, scale = 3)
server$close()
